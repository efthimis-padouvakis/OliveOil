...
export default function ProductPage() {
  ...
  const requiredFields = {
    kodikos: "Κωδικός Προϊόντος",
    perigrafi: "Περιγραφή Προϊόντος",
    monadaMetrisis: "Μονάδα Μέτρησης",
    poiotita: "Ποιότητα",
    timi: "Τιμή",
    xyles: "Χύλες",
    katharoVaros: "Καθαρό Βάρος",
    meiktoVaros: "Μεικτό Βάρος",
    fpa: "ΦΠΑ",
    syskevasia: "Συσκευασία",
    varosSyskevasias: "Βάρος Συσκευασίας",
    dexameni: "Δεξαμενή",
  };
  ...
  function handleSubmit(e: React.FormEvent) {
    ...
    if (newErrors.length > 0) {
      ...
      setErrors([]);
      setSuccess("Επιτυχής καταχώρηση προϊόντος!");
      window.scrollTo({ top: 0, behavior: "smooth" });
